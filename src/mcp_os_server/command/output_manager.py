...
class OutputManager(IOutputManager):
    ...
    def _get_log_file_path(self, process_id: str, output_key: str) -> str:
        ...
        return os.path.join(process_output_dir, f"process_output.db")

    def _get_logger_for_process(self, process_id: str, output_key: str) -> SqliteOutputLogger:
        ...
        if output_key not in self._loggers[process_id]:
            ...
            self._loggers[process_id][output_key] = SqliteOutputLogger(log_file_path, sub_id=output_key)
